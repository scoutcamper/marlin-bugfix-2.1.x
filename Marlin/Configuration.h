...
#define STRING_CONFIG_H_AUTHOR "(scoutcamper, btt)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "scoutcamper"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 143.80
  #define DEFAULT_bedKi 28.09
  #define DEFAULT_bedKd 490.85
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 51.2, -10, 0 }
